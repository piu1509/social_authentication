...
class UserProfileView(View):
    def get(self, request, *args, **kwargs):
        ...
        #     user_membership__user__username=user.username)
        if not context['user_subscription']:
...
def send_otp(request):
    import requests
    api_key = "74e2ef66-ac56-11ed-813b-0200cd936042"
    phone_number = ""
    msg = "ILU ILU ILU,  #32345786438769843 "
    url = f'https://2factor.in/API/V1/{api_key}/SMS/{phone_number}/{msg}'
